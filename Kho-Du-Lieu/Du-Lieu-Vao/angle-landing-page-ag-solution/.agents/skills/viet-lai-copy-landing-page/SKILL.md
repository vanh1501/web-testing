---
name: viet-lai-copy-landing-page
description: |
  Viết landing page copy theo angle, dùng section playbooks và giữ nguyên section cố định.
---

# Skill: viet-lai-copy-landing-page

## Khi nào dùng

Dùng trong workflow `tao-landing-page-theo-angle` khi cần: Viết landing page copy theo angle, dùng section playbooks và giữ nguyên section cố định.
