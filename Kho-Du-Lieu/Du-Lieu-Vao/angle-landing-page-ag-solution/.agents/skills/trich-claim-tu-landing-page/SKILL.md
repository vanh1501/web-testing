---
name: trich-claim-tu-landing-page
description: |
  Trích và phân loại claim từ landing page gốc, claim library, sale kit và nguồn dự án.
---

# Skill: trich-claim-tu-landing-page

## Khi nào dùng

Dùng trong workflow `tao-landing-page-theo-angle` khi cần: Trích và phân loại claim từ landing page gốc, claim library, sale kit và nguồn dự án.
