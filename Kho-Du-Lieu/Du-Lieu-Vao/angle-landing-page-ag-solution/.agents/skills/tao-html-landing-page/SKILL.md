---
name: tao-html-landing-page
description: |
  Tạo file HTML landing page hoàn chỉnh từ copy đã duyệt.
---

# Skill: tao-html-landing-page

## Khi nào dùng

Dùng trong workflow `tao-landing-page-theo-angle` khi cần: Tạo file HTML landing page hoàn chỉnh từ copy đã duyệt.
