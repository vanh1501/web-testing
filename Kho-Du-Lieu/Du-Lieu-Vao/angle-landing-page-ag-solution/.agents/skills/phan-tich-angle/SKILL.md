---
name: phan-tich-angle
description: |
  Phân tích content angle thành insight, pain, promise, hook, CTA direction và risk note.
---

# Skill: phan-tich-angle

## Khi nào dùng

Dùng trong workflow `tao-landing-page-theo-angle` khi cần: Phân tích content angle thành insight, pain, promise, hook, CTA direction và risk note.
