---
name: tao-github-handoff
description: |
  Tạo gói bàn giao GitHub: file name, branch, commit, PR description, lệnh Git mẫu.
---

# Skill: tao-github-handoff

## Khi nào dùng

Dùng trong workflow `tao-landing-page-theo-angle` khi cần: Tạo gói bàn giao GitHub: file name, branch, commit, PR description, lệnh Git mẫu.
