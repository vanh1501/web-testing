---
name: 00-tao-html-landing-page
description: |
  Tạo file HTML landing page hoàn chỉnh từ copy đã duyệt.
---

# Skill: 00-tao-html-landing-page

## Khi nào dùng

Dùng trong workflow `00-tao-landing-page-theo-angle` khi cần: Tạo file HTML landing page hoàn chỉnh từ copy đã duyệt.
