---
name: 00-phan-tich-angle
description: |
  Phân tích content angle thành insight, pain, promise, hook, CTA direction và risk note.
---

# Skill: 00-phan-tich-angle

## Khi nào dùng

Dùng trong workflow `00-tao-landing-page-theo-angle` khi cần: Phân tích content angle thành insight, pain, promise, hook, CTA direction và risk note.
