---
name: 00-kiem-tra-html
description: |
  Kiểm tra HTML trước GitHub handoff: CTA, form, responsive, section giữ nguyên, claim.
---

# Skill: 00-kiem-tra-html

## Khi nào dùng

Dùng trong workflow `00-tao-landing-page-theo-angle` khi cần: Kiểm tra HTML trước GitHub handoff: CTA, form, responsive, section giữ nguyên, claim.
