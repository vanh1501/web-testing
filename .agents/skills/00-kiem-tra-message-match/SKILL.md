---
name: 00-kiem-tra-message-match
description: |
  Kiểm tra angle → Hero → Problem → Why → USP → CTA, bao gồm show-don’t-tell.
---

# Skill: 00-kiem-tra-message-match

## Khi nào dùng

Dùng trong workflow `00-tao-landing-page-theo-angle` khi cần: Kiểm tra angle → Hero → Problem → Why → USP → CTA, bao gồm show-don’t-tell.
